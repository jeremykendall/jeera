...
class Jeera_PasswordHash
{
     ...
     * @param bool $portable_hashes If true, use portable, MD5-based hash
     */
    ...
    /**
     * Test plain text password against hash
     *
     * @param string $password plain text password
     * @param string $stored_hash password hash
    ...
    /**
     * Create hash from pain text password
     * 
     * @param string $password Plain text password
